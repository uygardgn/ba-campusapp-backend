...
{
    public class TrainingTypeCreateDtoValidator : AbstractValidator<TrainingTypeCreateDto>
    {
        private readonly IStringLocalizer<Resource> _stringLocalizer;

        public TrainingTypeCreateDtoValidator(IStringLocalizer<Resource> stringLocalizer)
        {
